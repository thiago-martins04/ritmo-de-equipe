            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 mt-8">
                    <div className="relative overflow-hidden rounded-sm shadow-lg group">
                        <img 
                            src="https://raw.githubusercontent.com/thiago-martins04/ritmodeequipe-site/refs/heads/main/ritmo-de-equipe-competicao.avif" 
                            alt="Competição de corrida" 
                    ...
                    <div className="relative overflow-hidden rounded-sm shadow-lg group">
                        <img 
                            src="https://raw.githubusercontent.com/thiago-martins04/ritmodeequipe-site/refs/heads/main/ritmo-de-equipe-pista_2.avif" 
                            alt="Pista de corrida profissional" 
                ...
                <div className="space-y-4">
                    <div className="relative overflow-hidden rounded-sm shadow-lg group">
                        <img 
                            src="https://raw.githubusercontent.com/thiago-martins04/ritmodeequipe-site/refs/heads/main/ritmo-de-equipe-pista.avif" 
                            alt="Atleta em pista" 
                            className="w-full h-48 object-cover transition-all duration-500"
                        />
                        <div className="absolute inset-0 bg-lime-400/20 opacity-0 group-hover:opacity-100 transition-opacity mix-blend-multiply"></div>
                    ...
                    <div className="relative overflow-hidden rounded-sm shadow-lg group">
                        <img 
                            src="https://raw.githubusercontent.com/thiago-martins04/ritmodeequipe-site/refs/heads/main/ritmo-de-equipe-trofeu.avif" 
                            alt="Troféu e vitórias" 
                            className="w-full h-64 object-cover transition-all duration-500"
                        />
                        <div className="absolute inset-0 bg-lime-400/20 opacity-0 group-hover:opacity-100 transition-opacity mix-blend-multiply"></div>
                    </div>
